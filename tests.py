...
from .stuff import games, templates
...
class Top8erTests(TestCase):
    ...
    @parameterized.expand([slug for slug, _ in games])
...
class Top8erAPITests(TestCase):
    ...
    @parameterized.expand([game for _, game in games])
    @tag("api")
    ...
    @parameterized.expand(templates)
    @tag("api")
